<template>
  <section
    ...
    <span v-if="passwordReveal" class="icon-button"><button type="button" @click="handleClick"><lit-icon :icon="icon" :iconset="iconset"></lit-icon></button></span>
    <span class="icon absolute"><lit-icon :icon="inputIcon" :iconset="iconset"></lit-icon></span>
  </section>
</template>
