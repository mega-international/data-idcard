...
class="ma-input"
    ...
    <span v-if="passwordReveal" class="icon-button"><button type="button" @click="handleClick"><lit-icon :icon="passwordIcon" :iconset="iconset"></lit-icon></button></span>
    <span v-if="!passwordReveal && icon" class="icon-button"><lit-icon :icon="icon" :iconset="iconset"></lit-icon></span>
  </section>
</template>
